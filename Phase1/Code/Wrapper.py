...
def main():
    ...
    def get_pb_lite_image(src_image, canny_image, sobel_image, img_number):
        if not os.path.exists(img_number):
            os.mkdir(img_number)
        img = src_image
        ...
        plt.imsave(img_number + "/" + "image" + img_number + "_t_map.png", texture_map)
        ...
        plt.imsave(img_number + "/" + "image" + img_number + "_b_map.png", b_map, cmap='gray')
        ...
        plt.imsave(img_number + "/" + "image" + img_number + "_c_map.png", c_map)
        ...
        plt.imsave(img_number + "/" + "image" + img_number + "_t_g_map.png", texton_gradient)
        plt.imsave(img_number + "/" + "image" + img_number + "_b_g_map.png", brightness_gradient)
        plt.imsave(img_number + "/" + "image" + img_number + "_c_g_map.png", colour_gradient)
        ...
        pb_lite_output = np.multiply(((1 / 3) * (texton_gradient + brightness_gradient + colour_gradient)),
                                     canny_sobel_product)
        plt.imsave(img_number + "/" + "image" + img_number + "_pb_lite.png", pb_lite_output, cmap="gray")
        print("Done with image " + img_number + "!")
        return pb_lite_output

    my_path = input("Please give the path to the directory where the package 'bsoothra_hw0' is located: ")
    prnt_drctry = my_path + "/bsoothra_hw0/Phase1/BSDS500"
    img_drctry = prnt_drctry + "/Images"
    cny_drctry = prnt_drctry + "/CannyBaseline"
    sbl_drctry = prnt_drctry + "/SobelBaseline"
    for file_name in os.listdir(img_drctry):
        if ".jpg" in file_name:
